 ...
 */
function generateMerkleTree(depth, zeroValue, arity, leaves) {
...
function generateMerkleProof(depth, zeroValue, arity, leaves, leaf) {
    ...
    var tree = generateMerkleTree(depth, zeroValue, arity, leaves);
...
var RLN = /** @class */ (function () {
    ...
    RLN.genProof = function (witness, wasmFilePath, finalZkeyPath) {
...
var Semaphore = /** @class */ (function () {
     ...
     */
    /* istanbul ignore next */
    Semaphore.genProof = function (witness, wasmFilePath, finalZkeyPath) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, proof, publicSignals;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    /* istanbul ignore next */
    Semaphore.verifyProof = function (verificationKey, _a) {
        var proof = _a.proof, publicSignals = _a.publicSignals;
        return groth16.verify(verificationKey, [
            publicSignals.merkleRoot,
     ...
     */
    /* istanbul ignore next */
    Semaphore.packToSolidityProof = function (fullProof) {
...
export { RLN, Semaphore, genExternalNullifier, genSignalHash, generateMerkleProof, generateMerkleTree };
