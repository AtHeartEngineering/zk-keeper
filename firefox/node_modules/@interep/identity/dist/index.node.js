/**
 * @module @interep/identity
 * @version 0.1.1
 * @file A simple JS function to create Interep identities.
 * @copyright Omar Desogus 2022
 * @license MIT
 * @see [Github]{@link https://github.com/interep/interep.js/tree/main/packages/identity}
*/
'use strict';

var identity = require('@zk-kit/identity');
 ...
 */
function createIdentity(sign, provider, nonce) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sign("Sign this message to generate your " + provider + " Semaphore identity with key nonce: " + nonce + ".")];
                case 1:
                    message = _a.sent();
                    return [2 /*return*/, new identity.ZkIdentity(identity.Strategy.MESSAGE, message)];
            }
        });
    });
}
